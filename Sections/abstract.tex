...
%%%%%% Cluster analysis %%%%%%
% The first chapter of the thesis employs aggressive gene filtering, retaining genes that are highly expressed in approximately 90\% of the TCGA samples, along with a simple cluster analysis.
