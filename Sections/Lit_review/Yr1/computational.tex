...
\subsection{Clustering} \label{s:lit:clustering}
...
\subsection{Graph Theory} \label{s:lit:graph_overview}
...
\subsection{Choosing the right ML approach} \label{s:lit:neuroevolution}
