...
\fbox {
    \parbox{\linewidth}{
      \begin{itemize}
        \item Focus on the clustering methods of RNAseq data for MIBC subtyping
...
\begin{figure}[!htb]    
    \centering
\includegraphics[width=0.9\textwidth,height=0.9\textheight,keepaspectratio]{Sections/Lit_review/Resources/consensus_network_classifier.jpg}
    \caption{Showing the network to classify the MIBC subgroups.}
    \label{fig:lit:consensus_network}
\end{figure}


% Re-introduce the consensus work
Cancer is not a single disease and it has been a lot of effort in subtyping the cancers as defining subgroups will help to diagnose and treat patients. In the 2020 paper \citet{Kamoun2020-tj} combine six approaches \cite{Mo2018-rl, Damrauer2014-tc, Choi2014-ed, Marzouka2018-ge, Rebouissou2014-ep,Robertson2017-mg} on bladder cancer subtyping to find a consensus in subgrouping. 
