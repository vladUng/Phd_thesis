...
\Cref{s:lit:computational} lays the foundational knowledge for the methods applied throughout the project, i.e., \cref{s:clustering_analysis,s:N_I,s:N_II}. It introduces the datasets used in the project in \cref{s:lit:datasets_used}, the cluster analysis methods used in \cref{s:lit:clustering}, the concept of a graphs and how to describe them in \cref{s:lit:graph_overview} as well as the tools to analyse the novel MIBC subtypes found in \cref{s:lit:gene_analysis,s:lit:survival}. 
