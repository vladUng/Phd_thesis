...
\begin{figure}[!htb]
    ...
    \caption[Example of Kaplam-Meier]{Kaplan-Meier survival analysis of the MIBC groups identified using the clustering analysis in \cref{s:clustering_analysis}. For example the survival rate of Ne is worst than the others, by having $\sim$30\% at 30 months (2 years and a half).}
