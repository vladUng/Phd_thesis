...
Both gene expression datasets used in this project were pseudo-aligned using the Kallisto method \citep{Bray2016-cv} and genome version GRCh38 with Gencode annotation version 42 which resulted in $\sim33k$ genes for each dataset. Kallisto is preferred for its computational performance while maintaining accuracy.
