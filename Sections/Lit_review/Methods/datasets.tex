...
% Linking to the TCGA
By their differentiation status both Abs-Ca and P0 are closer to Luminal samples in the MIBC. As undifferentiated urothelial cells, UD transcriptomes are closer to basal MIBC subtypes. These aspects are observed in the analysis performed in the selective edge pruning (\cref{s:N_I:sel_pruning}) and in the work with the second version of the network pipeline in (\cref{s:N_II:std_net}).
