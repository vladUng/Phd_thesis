...
% Another review from 2020 which focuses on network fusion is \citet{Di_Nanni2020-qu} which also covers the work from \citet{Dimitrakopoulos2018-br}.
...
\subsubsection{Multi-layer} \label{s:lit:multi-layer}
