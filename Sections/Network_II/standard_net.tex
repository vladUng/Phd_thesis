\section{Result} \label{s:N_II:results}

\subsection{Analysing the standard network} \label{s:N_II:std_net}


% Non-tum split
\subsubsection{Non-tumour split} \label{s:N_II:std}
...
% Abs-Ca splits
\subsubsection{Abs-Ca splits} \label{s:N_II:diff_split}
...
% P0 split
\subsubsection{P0 split} \label{s:N_II:p0_split}
...
\subsubsection{Community characterisation} \label{s:N_II:comm_charact}
...
% 
\subsubsection{MIBC split} \label{s:N_II:tum_split}
