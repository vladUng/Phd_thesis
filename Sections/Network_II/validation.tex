...
% IVI
The IVI distribution for the two tumour networks are not significantly different (\acrshort{mw}: 12532555.0, p-value: 0.8215), but there is a noticeable difference between the non-tumour standard and reward networks (\acrshort{mw}: 6702904.0, p-value: 0.8215). In the latter, the IVI distribution is elongating towards higher values, indicating that a subset of genes gained higher influence in the network, while the other's importance is lowered.
...
\begin{table}[!htb]
  ...
  \begin{tabularx}{\textwidth}{>{\hsize=.5\hsize}X|>{\hsize=.5\hsize}X|>{\hsize=.5\hsize}X}
    ...
    \bottomrule
  \end{tabularx}
  \caption[Non-tumour networks: Standard vs Reward]{Results of \acrlong{mw} for the betweenness, closeness, degree, PageRank, and IVI metrics comparing Standard and Reward networks, showing significant differences between the two graphs.}
...
\begin{table}[!htb]
  ...
  \begin{tabularx}{\textwidth}{>{\hsize=.5\hsize}X|>{\hsize=.5\hsize}X|>{\hsize=.5\hsize}X}
    ...
    \midrule
    \textbf{Reward 1 vs Reward 2} & 9695120.0; p-value: $4.137e^{-12}$ & 9287455.0; p-value: 0.0012 \\
    \midrule
    \textbf{Standard vs Reward 1} & 6101149.5; p-value: $8.240e^{-8}$ & 7098464.5; p-value: $5.322e^{-9}$ \\
    \midrule
    \textbf{Standard vs Reward 2} & 7233820.5; p-value: 0.280 & 9287455.0; p-value: $2.249e^{-19}$ \\
    \midrule
    \multicolumn{3}{c}{\textbf{Non-tumour}} \\
    \midrule 
     \textbf{Reward v1 vs Reward v2} & 4752647.0; p-value: $3.03e^{-17}$ & 4418659.0; p-value: 0.0017 \\
    \midrule
    \textbf{Standard vs Reward v1} & 4653638.5; p-value: $3.04e^{-17}$ & 5804760.5; p-value: $7.07e^{-12}$ \\
    \midrule
    \textbf{Standard vs Reward v2} & 3782724.0; p-value: 0.314 & 4276523.5; p-value: $3.79e^{-21}$ \\
    \bottomrule
  \end{tabularx}
  \caption[Reward modifiers: Effect on Rank and Mutation Burden]{Compares the Mutation burden and ModCon Rank distributions between the three networks.}
