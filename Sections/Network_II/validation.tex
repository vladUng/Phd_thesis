...
\begin{figure}[!htb]    
    ...
    \caption{Network metrics for the Tumour and non-tumour networks with no modifier and reward modifier. The y-axis represent the log10 of the metric.  See \cref{s:lit:net_metrics} for a description of the metrics. }
