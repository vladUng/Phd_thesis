...
\begin{enumerate}
    \item \textbf{Tumour standard} - graph derived from tumour dataset without mutation burden integration (red)
    \item \textbf{Tumour reward} - graph derived from tumour dataset with mutation burden integration (mustard)
    \item \textbf{Non-tumour standard} - graph derived using the non-tumour dataset without mutation burden integration (green)
    \item \textbf{Non-tumour reward} - graph derived using the non-tumour dataset with mutation burden integration (blue)
\end{enumerate}
