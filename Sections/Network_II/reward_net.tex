...
Group 6 from \cref{fig:N_II:sankey_comp} is one of the smallest luminal groups found in this project, which also has a good survival prognosis \cref{fig:N_II:survival_K_7}. The first quadrant from \cref{fig:N_II:pi_lum_6}  represents the points that are specific to both Lum\_3 and Lum\_2, while the third quadrant contains all the genes that are specific to cluster 6. 
