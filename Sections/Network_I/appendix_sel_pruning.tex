...
% Leiden vs SBM
\subsection{Leiden vs SBM} \label{s:ap:leiden_sbm}
...
\subsection{Clustering dendrogram} \label{s:ap:leiden_sbm}
...
\subsection{Tumour vs Non-tumour gene expression} \label{s:ap:tum_vs_non-tumour}
...
\subsection{TCGA metadata and the clusters based on the 98 TFs} \label{s:ap:sel_prun_tcga_meta}
...
\subsection{TCGA somatic mutation} \label{s:ap:sel_prun_mut}
...
% GSEA plots
\subsection{GSEA plots top 10 by Enrichment score}
