...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{>{\hsize=.25\hsize}X|>{\hsize=.75\hsize}X}
    ...
    \bottomrule
  \end{tabularx}
  \caption{The 98TFs markers categorised by Luminal and Basal subtypes.} % Caption for the table
...
% Then introduce the Pi plot for SmallBasal vs the others

\paragraph*{Understanding the subtypes}


% Pi plot for Small Ba/Sq
\begin{figure}[!htb]   
\centering
\includegraphics[width=1.0\textwidth,height=1.0\textheight,keepaspectratio]{Sections/Network_I/Resources/selective_pruning/top_500_Pi_smallBasal.png}
