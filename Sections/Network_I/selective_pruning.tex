...
% Then introduce the GSEA parameters

% Filtering - how it was choosen the 10 and then doing the intersection

% Present all of these pathways 
%  - Specific to each subtype
% - small, large, lump, lumInf, mes-like

% Sepcific to luminal and specific to basal
...
\begin{itemize}
    ...
    \begin{todolist}
        ...
        \item GSEA enrichment on the Small Basal
        \item GSEA enrichment of the other 
    \end{todolist}
    ...
    \begin{todolist}
        ...
        \item Showing the neighbours for some of the TFs: BNC1, AHR, HES2
