...
\begin{table}[!htb]
  ...
  \begin{tabularx}{\textwidth}{>{\hsize=.25\hsize}X|>{\hsize=.75\hsize}X}
    ...
    \bottomrule
  \end{tabularx}
  \caption[Luminal and Basal markers from the 98 TFs]{The 98 transcription factors markers categorised by Luminal and Basal subtypes.} % Caption for the table
