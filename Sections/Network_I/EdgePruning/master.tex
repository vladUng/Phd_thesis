...
\fbox{
    \parbox{0.95\linewidth}{
      \begin{itemize}
        \item Finding the minimum degree for TFs 
        \item Subset of 98 are highly connected in the network
        \item Basal samples with the lowest survival rate
      \end{itemize}
    }
}
\vspace{3mm}
