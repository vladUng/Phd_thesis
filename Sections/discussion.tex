...
% The main challenge of the project was measuring the success of the refinements in computational methods which is also one of the challenges in unsupervised learning applications. To measure the impact of the changes in the network, clustering metrics were used that do not require the ground truth such as the Silhouette score or network metrics. These tools help verify whether modifications to the methods affect the output. However, they do not provide any indication of whether the changes made to the network have a natural biological impact. To address this, domain knowledge or further analysis was employed.

% The main challenge of the project was measuring the success of the refinements in the computational framework, which is also one of the challenges in unsupervised learning applications. To measure the changes in the network pipeline, clustering metrics that do not require ground truth (e.g., Silhouette score) or network metrics (e.g., degree, closeness) were used. These tools help verify whether method modifications affect the graphs and the \gls{MIBC} subgroups. However, they do not provide any indication of whether the changes made to the network have a biological impact. To address this, domain knowledge or further analysis was employed.

% One of the primary challenges we faced in the project was assessing the effectiveness of the refinements in our computational methods, especially in unsupervised learning applications. To gauge the impact of the changes in the network pipeline, we utilised clustering metrics like the Silhouette score, which do not rely on ground truth, as well as network metrics such as degree and closeness. While these tools helped us understand how method modifications influenced the graphs and MIBC subgroups, they did not reveal whether the network changes had a biological impact. To address this, we turned to domain knowledge and additional analysis.

One of the primary challenges in the project was assessing the effectiveness of the refinements in the computational methods, particularly in unsupervised learning applications. Clustering metrics such as the Silhouette score, which does not rely on ground truth, were utilised to gauge the impact of the changes in the network pipeline, along with network metrics such as degree and closeness. While these tools helped to understand how method modifications influenced the graphs and \gls{MIBC} subgroups, they did not reveal whether the network changes had a biological impact. To address this, domain knowledge and additional analysis were employed.
