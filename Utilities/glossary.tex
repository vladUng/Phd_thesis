...
\newglossaryentry{MIBC}
{
    ...
    description={One of the two major types of bladder cancer, it is more aggressive and it is metastatic. At first presentation 30\% of the bladder cancer patients are MIBC. The project focuses on researching this disease.}
}
